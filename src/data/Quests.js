...
export const QUESTS = {
  ...
  firstBlood: Q({
    id: 'firstBlood', name: 'First Blood', icon: '⚔', chapter: 1,
  ...
  learnTheLine: Q({
    id: 'learnTheLine', name: 'Hold the Line', icon: '🛡', chapter: 1,
  ...
  firstUpgrade: Q({
    id: 'firstUpgrade', name: 'Veteran Steel', icon: '▲', chapter: 1,
  ...
  meetTheWizard: Q({
    id: 'meetTheWizard', name: 'Mind the Third Step', icon: '🧙', chapter: 1,
  ...
  firstForge: Q({
    id: 'firstForge', name: 'Hot Work', icon: '🔨', chapter: 1,
  ...
  combinedArms: Q({
    id: 'combinedArms', name: 'Combined Arms', icon: '⚖', chapter: 2,
  ...
  theCheapWay: Q({
    id: 'theCheapWay', name: 'The Cheap Way', icon: '🐜', chapter: 2,
  ...
  untouched: Q({
    id: 'untouched', name: 'Untouched', icon: '👑', chapter: 2,
  ...
  pointsMatter: Q({
    id: 'pointsMatter', name: 'Ground Is Everything', icon: '🚩', chapter: 2,
  ...
  siegeMaster: Q({
    id: 'siegeMaster', name: 'Siege Master', icon: '🪨', chapter: 3,
  ...
  perfectCounter: Q({
    id: 'perfectCounter', name: 'The Right Tool', icon: '🎯', chapter: 3,
  ...
  oilAndFlame: Q({
    id: 'oilAndFlame', name: 'Pitch and Flame', icon: '🔥', chapter: 3,
  ...
  tenTen: Q({
    id: 'tenTen', name: 'Ten at Ten', icon: '▲', chapter: 4,
  ...
  awakened: Q({
    id: 'awakened', name: 'Awakened', icon: '🌟', chapter: 5,
  ...
  wellDressed: Q({
    id: 'wellDressed', name: 'Well Dressed', icon: '🦺', chapter: 3,
  ...
  scholar: Q({
    id: 'scholar', name: 'Scholar', icon: '📖', chapter: 4,
  ...
  region4: Q({ id: 'region4', name: 'Hollowmere Rests', icon: '💀', chapter: 4,
  ...
  region5: Q({ id: 'region5', name: 'The Crown Restored', icon: '👑', chapter: 5,
  ...
  dailyDrill: Q({
    id: 'dailyDrill', name: 'Keep Them Sharp', icon: '🎖', chapter: 0, repeatable: true,
    desc: 'Win 3 battles.',
    target: 3, track: { evt: EV.BATTLE_END, test: p => p.victory },
    reward: { gold: 300, scroll: 1 },
  }),
  slayer: Q({
    id: 'slayer', name: 'Attrition', icon: '💀', chapter: 0, repeatable: true,
