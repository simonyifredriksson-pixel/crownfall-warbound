...
export const SLOTS = {
  weapon:  { id: 'weapon',  name: 'Weapon',    icon: ic('swords') },
  offhand: { id: 'offhand', name: 'Off-hand',  icon: ic('shield') },
  head:    { id: 'head',    name: 'Helm',      icon: ic('helm') },
  chest:   { id: 'chest',   name: 'Chest',     icon: ic('chest') },
  hands:   { id: 'hands',   name: 'Gauntlets', icon: ic('gloves') },
  feet:    { id: 'feet',    name: 'Boots',     icon: ic('boots') },
  trinket1:{ id: 'trinket1',name: 'Trinket I', icon: ic('ring'), family: 'trinket' },
  trinket2:{ id: 'trinket2',name: 'Trinket II',icon: ic('amulet'), family: 'trinket' },
};
...
export const WEAPON_CLASSES = {
  sword: {
    id: 'sword', name: 'Sword', icon: ic('dagger'),
  ...
  greatsword: {
    id: 'greatsword', name: 'Greatsword', icon: ic('swords'),
  ...
  hammer: {
    id: 'hammer', name: 'Warhammer', icon: ic('hammer'),
  ...
  spear: {
    id: 'spear', name: 'Spear', icon: ic('trident'),
  ...
  daggers: {
    id: 'daggers', name: 'Twin Daggers', icon: ic('dagger'),
  ...
  staff: {
    id: 'staff', name: 'Staff', icon: ic('arcane'),
...
export const ITEMS = {
  ...
  ironSword: I({
    ...
    icon: ic('dagger'), stats: { might: 16, weight: 4 },
  ...
  steelLongsword: I({
    ...
    icon: ic('dagger'), stats: { might: 34, haste: 5, weight: 5 },
  ...
  silverbrand: I({
    ...
    icon: ic('swords'), stats: { might: 48, focus: 10, weight: 5 },
  ...
  kingsEdge: I({
    ...
    icon: ic('crown'), stats: { might: 118, focus: 34, haste: 14, vigor: 180, weight: 6 },
  ...
  ironGreatsword: I({
    ...
    icon: ic('swords'), stats: { might: 28, weight: 14 },
  ...
  dragonboneCleaver: I({
    ...
    icon: ic('dragon'), stats: { might: 92, vigor: 120, weight: 11 },
  ...
  woodaxe: I({
    ...
    icon: ic('axe'), stats: { might: 20, weight: 6 },
  ...
  reaverAxe: I({
    ...
    icon: ic('axe'), stats: { might: 52, haste: 8, weight: 8 },
  ...
  ironMaul: I({
    ...
    icon: ic('hammer'), stats: { might: 26, armor: 3, weight: 16 },
  ...
  mountainbreaker: I({
    ...
    icon: ic('mountain'), stats: { might: 104, armor: 14, vigor: 160, weight: 24 },
  ...
  huntingSpear: I({
    ...
    icon: ic('trident'), stats: { might: 17, haste: 4, weight: 5 },
  ...
  wyrmlance: I({
    ...
    icon: ic('trident'), stats: { might: 58, haste: 12, focus: 14, weight: 6 },
  ...
  cutpurseKnives: I({
    ...
    icon: ic('dagger'), stats: { might: 13, haste: 18, weight: 2 },
  ...
  nightfang: I({
    ...
    icon: ic('void'), stats: { might: 44, haste: 30, focus: 20, weight: 2 },
  ...
  shortbow: I({
    ...
    icon: ic('bow'), stats: { might: 18, haste: 6, weight: 3 },
  ...
  stormdraw: I({
    ...
    icon: ic('stamina'), stats: { might: 76, focus: 30, haste: 16, weight: 4 },
  ...
  apprenticeStaff: I({
    ...
    icon: ic('arcane'), stats: { focus: 22, might: 4, weight: 3 },
  ...
  emberstaff: I({
    ...
    icon: ic('flame'), stats: { focus: 54, vigor: 60, weight: 4 },
  ...
  aethervoidStaff: I({
    ...
    icon: ic('vortex'), stats: { focus: 142, vigor: 140, haste: 18, weight: 5 },
  ...
  woodShield: I({
    ...
    icon: ic('shield'), stats: { armor: 10, vigor: 50, weight: 7 },
  ...
  towerShield: I({
    ...
    icon: ic('shield'), stats: { armor: 32, vigor: 180, weight: 22 },
  ...
  wardingSigil: I({
    ...
    icon: ic('talisman'), stats: { focus: 48, armor: 14, vigor: 100, weight: 2 },
  ...
  crownAegis: I({
    ...
    icon: ic('crown'), stats: { armor: 64, vigor: 380, focus: 40, weight: 18 },
  ...
  /* --- heavy ----------------------------------------------------------- */
  ironHelm:   I({ id: 'ironHelm', name: 'Iron Helm', slot: 'head', rarity: 'common', tier: 1, icon: ic('helm'),
  ...
  ironPlate:  I({ id: 'ironPlate', name: 'Iron Cuirass', slot: 'chest', rarity: 'common', tier: 1, icon: ic('chest'),
  ...
  ironGauntlets: I({ id: 'ironGauntlets', name: 'Iron Gauntlets', slot: 'hands', rarity: 'common', tier: 1, icon: ic('gloves'),
    stats: { armor: 6, might: 6, weight: 5 }, family: 'heavy',
    visual: { style: 'plate', metal: 0x8a9098 }, desc: 'Articulated fingers. Mostly.' }),
  ironSabatons: I({ id: 'ironSabatons', name: 'Iron Sabatons', slot: 'feet', rarity: 'common', tier: 1, icon: ic('boots'),
    stats: { armor: 6, vigor: 30, weight: 7 }, family: 'heavy',
    visual: { style: 'plate', metal: 0x8a9098 }, desc: 'Heavy boots for a heavy commander.' }),

  knightHelm: I({ id: 'knightHelm', name: 'Knight\'s Great Helm', slot: 'head', rarity: 'uncommon', tier: 2, icon: ic('helm'),
  ...
  knightPlate: I({ id: 'knightPlate', name: 'Knight\'s Plate', slot: 'chest', rarity: 'uncommon', tier: 2, icon: ic('chest'),
  ...
  knightGauntlets: I({ id: 'knightGauntlets', name: 'Knight\'s Gauntlets', slot: 'hands', rarity: 'uncommon', tier: 2, icon: ic('gloves'),
    stats: { armor: 14, might: 16, weight: 6 }, family: 'heavy',
    visual: { style: 'plate', metal: 0xc0c8d4, trim: 0xc0a040 }, desc: 'Good steel, good grip.' }),
  knightSabatons: I({ id: 'knightSabatons', name: 'Knight\'s Sabatons', slot: 'feet', rarity: 'uncommon', tier: 2, icon: ic('boots'),
  ...
  dragonHelm: I({ id: 'dragonHelm', name: 'Dragonbone Helm', slot: 'head', rarity: 'epic', tier: 3, icon: ic('dragon'),
  ...
  dragonPlate: I({ id: 'dragonPlate', name: 'Dragonbone Harness', slot: 'chest', rarity: 'epic', tier: 3, icon: ic('dragon'),
  ...
  dragonGauntlets: I({ id: 'dragonGauntlets', name: 'Dragonbone Gauntlets', slot: 'hands', rarity: 'epic', tier: 3, icon: ic('dragon'),
  ...
  dragonGreaves: I({ id: 'dragonGreaves', name: 'Dragonbone Greaves', slot: 'feet', rarity: 'epic', tier: 3, icon: ic('dragon'),
    stats: { armor: 30, vigor: 180, weight: 5 }, family: 'heavy',
    visual: { style: 'scale', metal: 0xc8a860, trim: 0xe8823a }, desc: 'Fast, for plate.' }),

  crownHelm: I({ id: 'crownHelm', name: 'The Iron Crown', slot: 'head', rarity: 'legendary', tier: 4, icon: ic('crown'),
  ...
  /* --- light ----------------------------------------------------------- */
  leatherHood: I({ id: 'leatherHood', name: 'Leather Hood', slot: 'head', rarity: 'common', tier: 1, icon: ic('helm'),
  ...
  leatherJerkin: I({ id: 'leatherJerkin', name: 'Leather Jerkin', slot: 'chest', rarity: 'common', tier: 1, icon: ic('chest'),
  ...
  leatherGloves: I({ id: 'leatherGloves', name: 'Leather Gloves', slot: 'hands', rarity: 'common', tier: 1, icon: ic('gloves'),
    stats: { haste: 8, might: 4, weight: 1 }, family: 'light',
    visual: { style: 'wrap', cloth: 0x5a4a3a }, desc: 'Grip, and nothing else.' }),
  leatherBoots: I({ id: 'leatherBoots', name: 'Travelling Boots', slot: 'feet', rarity: 'common', tier: 1, icon: ic('boots'),
  ...
  rangerHood: I({ id: 'rangerHood', name: 'Ranger\'s Hood', slot: 'head', rarity: 'rare', tier: 2, icon: ic('helm'),
  ...
  rangerCoat: I({ id: 'rangerCoat', name: 'Ranger\'s Coat', slot: 'chest', rarity: 'rare', tier: 2, icon: ic('chest'),
  ...
  rangerGloves: I({ id: 'rangerGloves', name: 'Ranger\'s Bracers', slot: 'hands', rarity: 'rare', tier: 2, icon: ic('gloves'),
  ...
  rangerBoots: I({ id: 'rangerBoots', name: 'Pathfinder Boots', slot: 'feet', rarity: 'rare', tier: 2, icon: ic('boots'),
  ...
  shadowHood: I({ id: 'shadowHood', name: 'Shroud of Nine Nights', slot: 'head', rarity: 'legendary', tier: 4, icon: ic('void'),
  ...
  /* --- magic ----------------------------------------------------------- */
  apprenticeHood: I({ id: 'apprenticeHood', name: 'Apprentice Hood', slot: 'head', rarity: 'common', tier: 1, icon: ic('mage'),
  ...
  apprenticeRobe: I({ id: 'apprenticeRobe', name: 'Apprentice Robe', slot: 'chest', rarity: 'common', tier: 1, icon: ic('robe'),
  ...
  apprenticeGloves: I({ id: 'apprenticeGloves', name: 'Sigil Wraps', slot: 'hands', rarity: 'common', tier: 1, icon: ic('gloves'),
    stats: { focus: 16, weight: 1 }, family: 'magic',
    visual: { style: 'wrap', cloth: 0x3b3f7a, glow: 0x9a6fe0 }, desc: 'Inked to the elbow.' }),
  apprenticeShoes: I({ id: 'apprenticeShoes', name: 'Soft Shoes', slot: 'feet', rarity: 'common', tier: 1, icon: ic('boots'),
  ...
  archmageHood: I({ id: 'archmageHood', name: 'Archmage\'s Circlet', slot: 'head', rarity: 'epic', tier: 3, icon: ic('spark'),
  ...
  archmageRobe: I({ id: 'archmageRobe', name: 'Archmage\'s Vestments', slot: 'chest', rarity: 'epic', tier: 3, icon: ic('robe'),
  ...
  archmageGloves: I({ id: 'archmageGloves', name: 'Conduit Wraps', slot: 'hands', rarity: 'epic', tier: 3, icon: ic('gloves'),
  ...
  archmageShoes: I({ id: 'archmageShoes', name: 'Stepless Slippers', slot: 'feet', rarity: 'epic', tier: 3, icon: ic('boots'),
  ...
  bloodPendant: I({ id: 'bloodPendant', name: 'Pendant of Red Hours', slot: 'trinket1', family: 'trinket', rarity: 'uncommon', tier: 1, icon: ic('amulet'),
  ...
  scholarRing: I({ id: 'scholarRing', name: 'Ring of Long Study', slot: 'trinket1', family: 'trinket', rarity: 'uncommon', tier: 1, icon: ic('ring'),
    stats: { focus: 30 }, special: { cdr: 0.1 },
    visual: { gem: 0x5aa6d8 }, desc: 'The Wizard has three. He will pretend this is the only one.' }),
  warhorn: I({ id: 'warhorn', name: 'Old Warhorn', slot: 'trinket1', family: 'trinket', rarity: 'rare', tier: 2, icon: ic('horn'),
  ...
  stoneheart: I({ id: 'stoneheart', name: 'Stoneheart', slot: 'trinket1', family: 'trinket', rarity: 'rare', tier: 2, icon: ic('rock'),
  ...
  phoenixFeather: I({ id: 'phoenixFeather', name: 'Phoenix Feather', slot: 'trinket1', family: 'trinket', rarity: 'epic', tier: 3, icon: ic('feather'),
  ...
  voidSigil: I({ id: 'voidSigil', name: 'Sigil of the Void', slot: 'trinket1', family: 'trinket', rarity: 'epic', tier: 3, icon: ic('vortex'),
  ...
  crownSeal: I({ id: 'crownSeal', name: 'Seal of the Iron Crown', slot: 'trinket1', family: 'trinket', rarity: 'legendary', tier: 4, icon: ic('medal'),
...
export const CMD_ABILITIES = {
  cmdRally: {
    id: 'cmdRally', name: 'Rally', icon: ic('horn'), cd: 22, key: 'Q', innate: true,
  ...
  cmdWarcry: {
    id: 'cmdWarcry', name: 'War Cry', icon: ic('rage'), cd: 26, key: 'E', innate: true,
  ...
  cmdCrownStrike: {
    id: 'cmdCrownStrike', name: 'Crown Strike', icon: ic('crown'), cd: 16, key: 'R',
  ...
  cmdShockwave: {
    id: 'cmdShockwave', name: 'Shockwave', icon: ic('burst'), cd: 14, key: 'R',
  ...
  cmdFirewall: {
    id: 'cmdFirewall', name: 'Firewall', icon: ic('flame'), cd: 18, key: 'R',
  ...
  cmdVoidRift: {
    id: 'cmdVoidRift', name: 'Void Rift', icon: ic('vortex'), cd: 24, key: 'R',
  ...
  cmdBastion: {
    id: 'cmdBastion', name: 'Bastion', icon: ic('shield'), cd: 28, key: 'R',
  ...
  cmdBlink: {
    id: 'cmdBlink', name: 'Blink', icon: ic('wind'), cd: 9, key: 'R',
  ...
  cmdVanish: {
    id: 'cmdVanish', name: 'Vanish', icon: ic('void'), cd: 20, key: 'R',
...
export const POTIONS = {
  healthPotion: {
    id: 'healthPotion', name: 'Health Draught', icon: ic('flask'), color: '#c5362b', tier: 1,
  ...
  speedPotion: {
    id: 'speedPotion', name: 'Draught of Swiftness', icon: ic('stamina'), color: '#ffd479', tier: 1,
  ...
  strengthPotion: {
    id: 'strengthPotion', name: 'Draught of Wrath', icon: ic('might'), color: '#e8823a', tier: 1,
  ...
  defensePotion: {
    id: 'defensePotion', name: 'Draught of Stone', icon: ic('rock'), color: '#8d95a3', tier: 1,
  ...
  magicPotion: {
    id: 'magicPotion', name: 'Draught of Insight', icon: ic('orb'), color: '#9a6fe0', tier: 2,
  ...
  commandPotion: {
    id: 'commandPotion', name: 'Banner Elixir', icon: ic('banner'), color: '#d9a441', tier: 2,
  ...
  antidote: {
    id: 'antidote', name: 'Antidote', icon: ic('clover'), color: '#8fbf4a', tier: 2,
  ...
  phoenixTonic: {
    id: 'phoenixTonic', name: 'Phoenix Tonic', icon: ic('flame'), color: '#ff8a3a', tier: 3,
