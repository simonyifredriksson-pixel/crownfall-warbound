...
export const REGIONS = {
  ...
  greenmarch: {
    ...
    faction: 'verrin', color: '#7d879c',
    tagline: 'Good farmland, and House Verrin is standing on it.',
    desc: 'Three days\' ride from the keep and already not yours. House Verrin crossed the boundary stones in spring and put a garrison on every crossing, and nobody stopped them, because there was nobody left to do it.',
    unlockedBy: null,
    recommendedLevel: 1,
    ...
    nodes: [
      {
        ...
        faction: 'verrin', level: 1, field: 'open',
        enemyDeck: ['verrinLevy', 'verrinLevy', 'verrinCrossbow'],
        intro: 'A Verrin picket and a hole in a fence. Everyone starts somewhere.',
        tutorial: 'deploy',
        waveLeadIn: 6,
        waves: [
          {
            name: 'A picket, alone', units: ['verrinLevy'], gap: 7,
          ...
          {
            name: 'They brought a crossbow', units: ['verrinLevy', 'verrinCrossbow'], gap: 7,
            teach: 'The crossbow stays at the back and shoots. Put the Mage behind the Knight and let the Knight walk into it.',
            after: 'Whatever is closest to the enemy is what the enemy kills. Choose who that is.',
          },
          {
            name: 'A proper rush', units: ['verrinLevy', 'verrinLevy', 'verrinLevy'], gap: 8,
          ...
          {
            name: 'A serjeant', units: ['verrinSerjeant', 'verrinLevy', 'verrinLevy'], gap: 6,
            teach: 'The serjeant holds them together. Break him and the levy behind him stops being a line.',
          },
        ],
      ...
      },
      {
        ...
        faction: 'verrin', level: 2, field: 'bridge',
        commander: 'mirelle',
        enemyDeck: ['verrinLevy', 'verrinLevy', 'verrinCrossbow', 'verrinPike'],
        intro: 'One crossing, and Mirelle Vance is already on it. A narrow front suits whoever has fewer bodies — that is you.',
        tutorial: 'chokepoint',
        waveLeadIn: 6,
        waves: [
          {
            name: 'Testing the crossing', units: ['verrinLevy', 'verrinLevy'], gap: 7,
            teach: 'One crossing. Put the Giant in it and nothing gets past him.',
          },
          {
            name: 'Crossbows on the far bank', units: ['verrinCrossbow', 'verrinCrossbow', 'verrinLevy'], gap: 7,
            teach: 'Crossbows will not close with you. Your Mage outranges them — set her up behind the Giant and walk her forward.',
            after: 'A chokepoint turns their numbers into a queue.',
          },
          {
            name: 'Pikes at the ford', units: ['verrinPike', 'verrinLevy', 'verrinLevy'], gap: 8,
            teach: 'Pikes. They will stop anything that charges them head-on. Go round, or send the Giant and eat the hit.',
            after: 'Formation is a decision, not a default.',
          },
          {
            name: 'Everything left', units: ['verrinLevy', 'verrinLevy', 'verrinCrossbow', 'verrinPike'], gap: 6,
      ...
      },
      {
        ...
        faction: 'verrin', level: 3, field: 'ridge',
        enemyDeck: ['verrinLevy', 'verrinCrossbow', 'verrinCrossbow', 'verrinSerjeant'],
        intro: 'They hold the barrow and their crossbows are on top of it. Shooters on a ridge reach further and hit harder — take the ridge or take the losses.',
        tutorial: 'highground',
      ...
      },
      {
        ...
        intro: 'Not soldiers. Something the Verrin garrison has been quietly pretending is not there.',
        rewards: { gold: 160, xp: 110, mats: { leather: 5, herb: 3 }, shards: 10 },
        first: { gold: 240, cards: ['houndPack'], mats: { heartwood: 1 } },
      },
      {
        id: 'gm6', name: 'Harrowfield Muster', type: 'elite', x: 48, y: 42, requires: ['gm4'],
        faction: 'verrin', level: 5, field: 'open',
        enemyDeck: ['verrinLevy', 'verrinLevy', 'verrinLevy', 'verrinOutrider', 'verrinSerjeant'],
        modifiers: ['swarm'],
        intro: 'A full Verrin line, two ranks deep, and outriders looking for your flank. Killing one man at a time will not hold this.',
      ...
      },
      {
        ...
        intro: 'A Verrin supply wagon nobody came back for.',
      ...
      {
        id: 'gm9', name: 'Greyward Castle', type: 'boss', x: 72, y: 20, requires: ['gm6', 'gm8'],
        faction: 'verrin', level: 7, field: 'ridge',
        commander: 'aldric', enemyFormation: 'shieldwall',
        enemyDeck: ['verrinLevy', 'verrinLevy', 'verrinCrossbow', 'verrinSerjeant', 'verrinOutrider'],
        mechanic: 'Ser Aldric never leaves his own line, and that line is a shield wall — almost nothing gets through the front of it. Send one squad wide, break the flank, and go in through the gap. Kill him and the battle ends, whatever is left standing.',
        intro: 'The Grey Marshal has drawn up on the ridge below his own gate, in two ranks, and has been waiting there since dawn.',
  ...
  blackbriar: {
    ...
    nodes: [
      ...
      },
      {
        ...
        faction: 'bandit', level: 9, field: 'forest',
        enemyDeck: ['banditCutthroat', 'banditCrossbow', 'banditCutthroat'],
        intro: 'Nets and stakes across every path. They want you stopped somewhere they have already measured.',
  ...
  ashenwaste: {
    ...
    faction: 'karn', color: '#b8523f',
    tagline: 'Open ground, and the worst possible place to be caught in column.',
    desc: 'Open downland with nothing to hide behind, which is exactly why House Karn keeps it. Halvi Karn has been riding west since the spring thaw and has not yet found anything that made her slow down.',
    unlockedBy: 'bb9',
    recommendedLevel: 12,
    ...
    nodes: [
      {
        ...
        faction: 'karn', level: 13, field: 'open',
        enemyDeck: ['karnHousecarl', 'karnHousecarl', 'karnLancer'],
        intro: 'Karn housecarls in plate, walking straight at you. Pierce will glance off. Blunt will not.',
        tutorial: 'armortypes',
      ...
      },
      {
        ...
        faction: 'karn', level: 14, field: 'canyon',
        enemyDeck: ['karnHousecarl', 'karnLancer', 'karnHornblower'],
        intro: 'A cut with one way through, and a hornblower at the far end keeping them moving. Narrow ground is the only place Karn cavalry is not terrifying.',
      ...
      },
      {
        ...
        icon: ic('pick'), intro: 'Good iron, if you are willing to go down the shaft for it.', event: 'slagpits',
      },
      {
        id: 'aw4', name: 'Boarpen Ridge', type: 'battle', x: 36, y: 42, requires: ['aw2'],
        faction: 'karn', level: 15, field: 'ridge',
        enemyDeck: ['karnDestrier', 'karnHousecarl', 'karnHousecarl', 'karnArbalest'],
        intro: 'Destriers. They charge in a straight line at enormous speed. Pikes and braced spears stop a charge. Everything else gets run over.',
        tutorial: 'antilarge',
      ...
      },
      {
        ...
        faction: 'karn', level: 16, field: 'ruins',
        enemyDeck: ['karnHornblower', 'karnHornblower', 'karnHousecarl', 'karnArbalest'],
        modifiers: ['fireGround'],
        intro: 'Two hornblowers and a wall of arbalests. Their line will not come to you; you will have to go and take it.',
        rewards: { gold: 390, xp: 330, mats: { emberglass: 6, steel: 5 }, shards: 19 },
        first: { gold: 580, cards: ['catapult'] },
      },
      {
        id: 'aw6', name: 'The Spur Fields', type: 'elite', x: 48, y: 30, requires: ['aw4'],
        faction: 'karn', level: 18, field: 'open',
        commander: 'brant', enemyFormation: 'wedge',
        enemyDeck: ['karnDestrier', 'karnDestrier', 'karnLancer', 'karnLancer', 'karnHornblower'],
        modifiers: ['enraged'],
        intro: 'Every rider here fights harder once they are bleeding. Finishing wounded enemies quickly is not optional.',
      ...
      },
      {
        ...
        icon: ic('crate'), repeatable: true,
        intro: 'A Karn baggage train that outran its own escort.',
        rewards: { gold: 220, mats: { emberglass: 5, steel: 5, iron: 8, dragonbone: 1 } },
      },
      {
        id: 'aw8', name: 'The Last Well', type: 'camp', x: 60, y: 18, requires: ['aw6'],
        icon: ic('flame'), intro: 'Clean water on the downs. People have died for less.', event: 'camp3',
      },
      {
        id: 'aw9', name: 'Spurhold Castle', type: 'boss', x: 76, y: 28, requires: ['aw6', 'aw8'],
        faction: 'karn', level: 20, field: 'canyon',
        commander: 'halvi', enemyFormation: 'wedge',
        enemyDeck: ['karnHousecarl', 'karnLancer', 'karnDestrier', 'karnHornblower'],
        mechanic: 'Halvi Karn ignores your army completely and rides straight at YOU. Standing still is how people die to her. Put pikes where she will arrive, keep moving, and make her come through them.',
        intro: 'She has been told you are coming. She has cleared a space, and she is already mounted.',
  ...
  hollowmere: {
    ...
    faction: 'freeCompany', color: '#9a8a5a',
    tagline: 'A lake that does not freeze and a town that does not empty.',
    desc: 'The Free Company has held Hollowmere on contract for nine years, for four different employers, without ever once breaking a term. Captain Ysolde Marrek has read everything you have ever done and charges accordingly.',
    unlockedBy: 'aw9',
    recommendedLevel: 19,
    ...
    nodes: [
      {
        ...
        faction: 'freeCompany', level: 20, field: 'open',
        enemyDeck: ['fcPikeman', 'fcPikeman', 'fcCrossbow'],
        intro: 'Company pikes, in a square, on ground they picked. Charging into the front of that is how you lose an army in nine seconds.',
        tutorial: 'holy',
      ...
      },
      {
        ...
        faction: 'freeCompany', level: 21, field: 'crypt',
        enemyDeck: ['fcPikeman', 'fcCrossbow', 'fcRoughrider', 'fcCaptain'],
        intro: 'Their roughriders go round your line, not through it, and they are going for your Mage. Keep something fast at home.',
        rewards: { gold: 500, xp: 450, mats: { boneMeal: 5, silver: 2 }, shards: 22 },
        first: { gold: 740, cards: ['crossbowman'], mats: { silver: 3 } },
      },
      {
        id: 'hm3', name: 'The Archivist\'s House', type: 'explore', x: 15, y: 42, requires: ['hm1'],
        icon: ic('codex'), intro: 'The Company\'s old muster rolls, left behind in a hurry. The Wizard would very much like to read them.', event: 'archivist',
      },
      {
        id: 'hm4', name: 'Bonefield', type: 'battle', x: 36, y: 44, requires: ['hm2'],
        faction: 'freeCompany', level: 23, field: 'open',
        enemyDeck: ['fcPikeman', 'fcPikeman', 'fcVeteran', 'fcCrossbow'],
        modifiers: ['corpseRise'],
        intro: 'Every man they lose is replaced from the baggage train within the minute. You cannot out-attrition a professional company — break their captain instead.',
        tutorial: 'corpses',
      ...
      },
      {
        ...
        faction: 'freeCompany', level: 25, field: 'crypt',
        enemyDeck: ['fcVeteran', 'fcRoughrider', 'fcRoughrider', 'fcCaptain', 'fcCrossbow'],
      ...
      {
        id: 'hm9', name: 'The Company Camp', type: 'boss', x: 78, y: 30, requires: ['hm6', 'hm8'],
        faction: 'freeCompany', level: 27, field: 'crypt',
        commander: 'ysolde', enemyFormation: 'echelon',
        enemyDeck: ['fcPikeman', 'fcCrossbow', 'fcRoughrider', 'fcVeteran'],
        mechanic: 'Ysolde re-forms her army to beat whatever you brought, and in echelon she cannot be flanked at all. Change your own formation before she finishes changing hers, then go straight at her — the Company does not hold once the Captain is down.',
        intro: 'She has your last four battles written down. She wants you to know that, and she is not bluffing.',
    ...
    nodes: [
      {
        ...
        faction: 'orsa', level: 27, field: 'canyon',
        enemyDeck: ['orsaHandgunner', 'orsaHandgunner', 'orsaHalberd'],
        intro: 'Orsa halberdiers behind a stake line. Anything that charges them is buying their engines another thirty seconds.',
        tutorial: 'reflect',
      ...
      },
      {
        ...
        faction: 'orsa', level: 28, field: 'ridge',
        enemyDeck: ['orsaHandgunner', 'orsaEngineer', 'orsaLevy'],
        modifiers: ['silenceAura'],
        intro: 'An Orsa engineer has oiled the whole approach and will set it alight the moment you are standing in it. Skirmish order, and do not bunch up.',
        tutorial: 'silence',
      ...
      },
      {
        ...
        faction: 'orsa', level: 31, field: 'crypt',
        enemyDeck: ['orsaLevy', 'orsaLevy', 'orsaEngineer', 'orsaHalberd'],
        intro: 'Handgunners. Armour does not help against them at all — your heavy line is decoration here. Bring numbers and bring them fast.',
        rewards: { gold: 880, xp: 760, mats: { voidEmber: 4, runestone: 3 }, shards: 27 },
        first: { gold: 1300, cards: ['krakenSpawn'], mats: { voidEmber: 4 } },
      },
      {
        id: 'ss6', name: 'The Gun Line', type: 'boss', x: 50, y: 36, requires: ['ss4'],
        faction: 'orsa', level: 33, field: 'spire',
        commander: 'tolvarr', enemyFormation: 'line',
        enemyDeck: ['orsaHandgunner', 'orsaHalberd', 'orsaEngineer', 'orsaBombard'],
        mechanic: 'Tolvarr stands behind his bombards, and a bombard cannot hit what is close to it. Cross the open ground in skirmish order so one shot does not take a whole squad, then get inside the minimum range and stay there.',
        intro: 'He has measured this field. He tells you which part he measured first, as a courtesy.',
