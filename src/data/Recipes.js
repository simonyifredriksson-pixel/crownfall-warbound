...
export const RECIPES = {
  ...
  craftAethervoidStaff: {
    ...
    name: 'Staff of the Aethervoid', icon: '🌀',
  ...
  craftIronPlateSet: {
    ...
    name: 'Iron Cuirass', icon: '🦺', cost: { iron: 6, leather: 3, gold: 160 }, unlock: {},
  },
  craftIronHelm: {
    id: 'craftIronHelm', station: 'forge', kind: 'item', out: 'ironHelm',
    name: 'Iron Helm', icon: '🪖', cost: { iron: 4, leather: 2, gold: 100 }, unlock: {},
  },
  craftLeatherJerkin: {
    id: 'craftLeatherJerkin', station: 'forge', kind: 'item', out: 'leatherJerkin',
    name: 'Leather Jerkin', icon: '🦺', cost: { leather: 6, cloth: 3, gold: 110 }, unlock: {},
  },
  craftIronGauntlets: {
    id: 'craftIronGauntlets', station: 'forge', kind: 'item', out: 'ironGauntlets',
    name: 'Iron Gauntlets', icon: '🧤', cost: { iron: 3, leather: 2, gold: 90 }, unlock: {},
  },
  craftIronSabatons: {
    id: 'craftIronSabatons', station: 'forge', kind: 'item', out: 'ironSabatons',
    name: 'Iron Sabatons', icon: '🥾', cost: { iron: 3, leather: 2, gold: 90 }, unlock: {},
  },
  craftLeatherHood: {
    id: 'craftLeatherHood', station: 'forge', kind: 'item', out: 'leatherHood',
    name: 'Leather Hood', icon: '🧢', cost: { leather: 4, cloth: 2, gold: 80 }, unlock: {},
  },
  craftKnightPlate: {
    id: 'craftKnightPlate', station: 'forge', kind: 'item', out: 'knightPlate',
    name: "Knight's Plate", icon: '🦺', cost: { steel: 10, leather: 5, gold: 700 }, unlock: { region: 'blackbriar' },
  },
  craftKnightHelm: {
    id: 'craftKnightHelm', station: 'forge', kind: 'item', out: 'knightHelm',
    name: "Knight's Great Helm", icon: '🪖', cost: { steel: 6, cloth: 3, gold: 420 }, unlock: { region: 'blackbriar' },
  },
  craftKnightGauntlets: {
    id: 'craftKnightGauntlets', station: 'forge', kind: 'item', out: 'knightGauntlets',
    name: "Knight's Gauntlets", icon: '🧤', cost: { steel: 5, leather: 3, gold: 340 }, unlock: { region: 'blackbriar' },
  },
  craftKnightSabatons: {
    id: 'craftKnightSabatons', station: 'forge', kind: 'item', out: 'knightSabatons',
    name: "Knight's Sabatons", icon: '🥾', cost: { steel: 5, leather: 3, gold: 340 }, unlock: { region: 'blackbriar' },
  },
  craftRangerCoat: {
    id: 'craftRangerCoat', station: 'forge', kind: 'item', out: 'rangerCoat',
    name: "Ranger's Coat", icon: '🦺', cost: { leather: 12, cloth: 6, steel: 3, gold: 640 }, unlock: { region: 'ashenwaste' },
  },
  craftRangerHood: {
    id: 'craftRangerHood', station: 'forge', kind: 'item', out: 'rangerHood',
    name: "Ranger's Hood", icon: '🧢', cost: { leather: 7, cloth: 4, gold: 380 }, unlock: { region: 'ashenwaste' },
  },
  craftRangerGloves: {
    id: 'craftRangerGloves', station: 'forge', kind: 'item', out: 'rangerGloves',
    name: "Ranger's Bracers", icon: '🧤', cost: { leather: 6, cloth: 3, gold: 320 }, unlock: { region: 'ashenwaste' },
  },
  craftRangerBoots: {
    id: 'craftRangerBoots', station: 'forge', kind: 'item', out: 'rangerBoots',
    name: 'Pathfinder Boots', icon: '🥾', cost: { leather: 6, heartwood: 1, gold: 340 }, unlock: { region: 'ashenwaste' },
  },
  craftTowerShield: {
    id: 'craftTowerShield', station: 'forge', kind: 'item', out: 'towerShield',
    name: 'Tower Shield', icon: '🛡', cost: { steel: 9, oak: 6, gold: 560 }, unlock: { region: 'blackbriar' },
  },
  craftDragonPlate: {
    id: 'craftDragonPlate', station: 'forge', kind: 'item', out: 'dragonPlate',
    name: 'Dragonbone Harness', icon: '🐉', cost: { dragonbone: 9, steel: 8, emberglass: 5, gold: 2600 }, unlock: { research: 'boneCuring' },
  },
  craftDragonHelm: {
    id: 'craftDragonHelm', station: 'forge', kind: 'item', out: 'dragonHelm',
    name: 'Dragonbone Helm', icon: '🐉', cost: { dragonbone: 5, steel: 5, gold: 1500 }, unlock: { research: 'boneCuring' },
  },
  craftDragonGauntlets: {
    id: 'craftDragonGauntlets', station: 'forge', kind: 'item', out: 'dragonGauntlets',
    name: 'Dragonbone Gauntlets', icon: '🐉', cost: { dragonbone: 4, steel: 4, gold: 1300 }, unlock: { research: 'boneCuring' },
  },
  craftDragonGreaves: {
    id: 'craftDragonGreaves', station: 'forge', kind: 'item', out: 'dragonGreaves',
    name: 'Dragonbone Greaves', icon: '🐉', cost: { dragonbone: 4, steel: 4, gold: 1300 }, unlock: { research: 'boneCuring' },
  },
  craftCrownHelm: {
    id: 'craftCrownHelm', station: 'forge', kind: 'item', out: 'crownHelm',
    name: 'The Iron Crown', icon: '👑',
  ...
  weaveShadowHood: {
    ...
    name: 'Shroud of Nine Nights', icon: '🌑',
  ...
  bindBloodPendant: {
    ...
    name: 'Pendant of Red Hours', icon: '📿',
  ...
  bindCrownSeal: {
    ...
    name: 'Seal of the Iron Crown', icon: '🎖',
  ...
  brewSpeed: {
    ...
    name: 'Draughts of Swiftness ×2', icon: '⚡',
  ...
  transmuteShards: {
    ...
    name: 'Echo of Battles Past', icon: '🔷',
