...
export const CURRENCIES = {
  gold:      { id: 'gold',      name: 'Gold',        icon: '🪙', color: '#d9a441', desc: 'Pays for upgrades, forging and the marketplace.' },
  warSeal:   { id: 'warSeal',   name: 'War Seal',    icon: '🎖', color: '#c5362b', desc: 'Earned from elite and boss victories. The Wizard trades for these and asks no questions.' },
  scroll:    { id: 'scroll',    name: 'Research Scroll', icon: '📜', color: '#5aa6d8', desc: 'Spent in the Library to unlock research.' },
};
