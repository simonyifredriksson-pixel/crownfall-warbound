...
export const STATUS = {
  ...
  burning: {
    id: 'burning', name: 'Burning', icon: ic('flame'), color: '#e8823a', kind: 'debuff',
  ...
  poisoned: {
    id: 'poisoned', name: 'Poisoned', icon: ic('flask'), color: '#8fbf4a', kind: 'debuff',
  ...
  bleeding: {
    id: 'bleeding', name: 'Bleeding', icon: ic('drop'), color: '#c5362b', kind: 'debuff',
  ...
  slowed: {
    id: 'slowed', name: 'Chilled', icon: ic('frost'), color: '#79cfe0', kind: 'debuff',
    stackable: true, maxStacks: 4, desc: 'Moves and attacks more slowly.',
    mods: { moveMult: 0.72, atkSpeedMult: 0.85 },
  },

  frozen: {
    id: 'frozen', name: 'Frozen', icon: ic('frost'), color: '#a8e6f0', kind: 'debuff',
  ...
  stunned: {
    id: 'stunned', name: 'Stunned', icon: ic('spark'), color: '#f3d98a', kind: 'debuff',
    desc: 'Cannot move, attack or use abilities.',
    mods: { moveMult: 0, atkSpeedMult: 0, stunned: true },
  },

  rooted: {
    id: 'rooted', name: 'Rooted', icon: ic('leaf'), color: '#5fa25a', kind: 'debuff',
    desc: 'Cannot move, but can still fight.',
    mods: { moveMult: 0 },
  },

  knockedback: {
    id: 'knockedback', name: 'Staggered', icon: ic('wind'), color: '#c8a98a', kind: 'debuff',
    desc: 'Being thrown. Cannot act until it lands.',
    mods: { atkSpeedMult: 0, stunned: true },
  },

  feared: {
    id: 'feared', name: 'Routed', icon: ic('fear'), color: '#b07fd0', kind: 'debuff',
    desc: 'Flees from the enemy instead of fighting.',
    mods: { fleeing: true, dmgMult: 0 },
  },

  taunted: {
    id: 'taunted', name: 'Taunted', icon: ic('target'), color: '#e08b7f', kind: 'debuff',
    desc: 'Forced to attack the taunter.',
  },

  silenced: {
    id: 'silenced', name: 'Silenced', icon: ic('silence'), color: '#9a6fe0', kind: 'debuff',
  ...
  phased: {
    id: 'phased', name: 'Phased', icon: ic('vortex'), color: '#9a6fe0', kind: 'buff',
    desc: 'Half in another world: takes 70% less damage but deals none.',
    mods: { dmgTakenMult: 0.3, dmgMult: 0, untargetable: false },
  },

  fortified: {
    id: 'fortified', name: 'Fortified', icon: ic('castle'), color: '#8d95a3', kind: 'buff',
    desc: 'Structure reinforced: +40% armour.',
    mods: { armorAdd: 14 },
  },

  empowered: {
    id: 'empowered', name: 'Empowered', icon: ic('orb'), color: '#9a6fe0', kind: 'buff',
    stackable: true, maxStacks: 3, desc: 'Spell power surges: +18% ability damage per stack.',
    mods: { abilityMult: 1.18 },
  },

  channeling: {
    id: 'channeling', name: 'Channelling', icon: ic('flame'), color: '#d9a441', kind: 'buff',
