...
export const RESEARCH = {
  ...
  metallurgy: {
    id: 'metallurgy', name: 'Metallurgy', branch: 'forge', icon: ic('gear'), tier: 1,
  ...
  boneCuring: {
    id: 'boneCuring', name: 'Bone Curing', branch: 'forge', icon: ic('dragon'), tier: 3,
  ...
  starforging: {
    id: 'starforging', name: 'Starforging', branch: 'forge', icon: ic('star'), tier: 4,
  ...
  crownwork: {
    id: 'crownwork', name: 'Crownwork', branch: 'forge', icon: ic('crown'), tier: 5,
  ...
  alchemy1: {
    id: 'alchemy1', name: 'Practical Alchemy', branch: 'alchemy', icon: ic('flask'), tier: 1,
  ...
  alchemy2: {
    id: 'alchemy2', name: 'Refined Reagents', branch: 'alchemy', icon: ic('alembic'), tier: 2,
  ...
  alchemy3: {
    id: 'alchemy3', name: 'Grand Distillation', branch: 'alchemy', icon: ic('flask'), tier: 4,
  ...
  transmutation: {
    id: 'transmutation', name: 'Transmutation', branch: 'alchemy', icon: ic('spark'), tier: 3,
  ...
  voidwork: {
    id: 'voidwork', name: 'Voidwork', branch: 'alchemy', icon: ic('vortex'), tier: 4,
  ...
  drillmaster: {
    id: 'drillmaster', name: 'Drillmaster', branch: 'war', icon: ic('medal'), tier: 1,
  ...
  quartermaster: {
    id: 'quartermaster', name: 'Quartermaster', branch: 'war', icon: ic('horn'), tier: 2,
  ...
  fieldSurgery: {
    id: 'fieldSurgery', name: 'Field Surgery', branch: 'war', icon: ic('heal'), tier: 2,
  ...
  siegecraft: {
    id: 'siegecraft', name: 'Siegecraft', branch: 'war', icon: ic('rock'), tier: 3,
  ...
  veterancy: {
    id: 'veterancy', name: 'Veterancy', branch: 'war', icon: ic('medal'), tier: 3,
  ...
  awakening: {
    id: 'awakening', name: 'The Awakening Rite', branch: 'war', icon: ic('star'), tier: 4,
  ...
  cartography: {
    id: 'cartography', name: 'Cartography', branch: 'lore', icon: ic('map'), tier: 1,
  ...
  bestiary: {
    id: 'bestiary', name: 'Bestiary', branch: 'lore', icon: ic('book'), tier: 2,
  ...
  prospecting: {
    id: 'prospecting', name: 'Prospecting', branch: 'lore', icon: ic('pick'), tier: 2,
  ...
  scholarship: {
    id: 'scholarship', name: 'Scholarship', branch: 'lore', icon: ic('mage'), tier: 3,
  ...
  farsight: {
    id: 'farsight', name: 'Farsight', branch: 'lore', icon: ic('eye'), tier: 4,
...
export const BRANCHES = {
  forge:   { id: 'forge',   name: 'Metallurgy', icon: ic('gear'), color: '#8d95a3' },
  alchemy: { id: 'alchemy', name: 'Alchemy',    icon: ic('flask'), color: '#8fbf4a' },
  war:     { id: 'war',     name: 'Warfare',    icon: ic('medal'), color: '#c5362b' },
  lore:    { id: 'lore',    name: 'Lore',       icon: ic('book'), color: '#5aa6d8' },
};
